...
| 2026-09-08 | tx 감사를 트랜잭션별 업무량·SQL·반복 상한·원자성·분리 조건으로 확장하고 전체 진입점 검토 표 추가. 외부 I/O 존재만으로 P1을 붙이던 기준 정정 | skills/backend-audit | 성민 요청: 기존 감사가 한 트랜잭션에 몰린 업무를 평가하지 않고 외부 I/O 탐지에 치우침. 같은 빈 호출·afterCommit 설명도 실제 경계 기준으로 정정 |
