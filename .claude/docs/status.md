...
- **없는 것**: 알림 이력/읽음 API(후속 티켓 — PRD 비목표), 주간 활동 요약(WEEKLY 카테고리 — MSG-315, V25 다음 CHECK 재정의 필요), 딥링크 데이터 페이로드(FCM 전송은 title·body 뿐)
