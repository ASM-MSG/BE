...
| `notifications` | `notification/entity/Notification` | ✅ (MSG-179 — V20 신설, 전 컬럼 매핑. 쓰기는 native 전용 — 기록 ON CONFLICT·상태 전이·UTC published_at/sent_at) |
| `reports` | — | ❌ 엔티티 없음 |
| `sponsor_ads` | — | ❌ 엔티티 없음 |
