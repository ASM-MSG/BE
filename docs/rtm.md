...
요약: FR 288건 중 테스트 연결 254건, 검증 공백 0건 (계획·폐기라 테스트 부재가 정상인 27건, 성격상 테스트 비대상 7건 별도)
...
| FR-USER-16 | 진행 중 | OrgAccountControllerTest, OrgAccountSecurityPersistenceTest, OrgEmailChangeConcurrencyTest |
