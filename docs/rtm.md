...
요약: FR 290건 중 테스트 연결 259건, 검증 공백 0건 (계획·폐기라 테스트 부재가 정상인 24건, 성격상 테스트 비대상 7건 별도)
...
| FR-EVENT-17 | 진행 중 | AdminEventUnpublishTest, EventSubmissionApprovalConcurrencyTest |
| FR-EVENT-18 | 구현됨 | AdminApprovedEventListTest |
