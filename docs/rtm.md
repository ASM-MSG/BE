...
요약: FR 221건 중 테스트 연결 192건, 검증 공백 0건 (계획·폐기라 테스트 부재가 정상인 22건, 성격상 테스트 비대상 7건 별도)
...
| FR-COLLECT-08 | 구현됨 | CollectionControllerTest, CollectionGridsRepositoryTest, UserGridQueryServiceImplTest |
...
| FR-MISSION-02 | 구현됨 | MissionControllerTest, MissionQueryServiceClockTest, MissionRepositoryTest |
| FR-MISSION-03 | 구현됨 | CourseSeedContractTest, MissionAwardQueryTest, MissionAwardServiceTest |
| FR-MISSION-04 | 구현됨 | FestivalMissionSeederIntegrationTest, MissionAwardQueryTest, MissionAwardServiceTest, MissionSchemaMigrationTest, PopupMissionSeederIntegrationTest, UserMissionRepositoryTest |
