...
**나중에(코스 미션 착수 시점에) 해소해도 되는 것 — 2026-07-31 MSG-225 착수 시점 정리**

- [ ] **코스 하나에 인증 장소를 몇 곳 두고, 몇 곳을 찍어야 완료로 칠까?**
  시작안은 "코스마다 5~8곳 중 3곳" — 일단 이걸로 착수하고 나중에 기획이 조정하는 전제.
- [x] ~~**관광 API 키 재발급**~~ — 수집 전(7/23 이전) 문구로 폐기. 키는 `~/fillmap-data/durunubi/.key`에
  보관돼 있고 GPX 148개도 전량 수집 완료 (2026-07-30 성민 정정).
- [x] ~~**걷기 코스가 몇 개인지부터 확인**~~ — 실수집으로 해소: 148개 확정 (전부 DNWW 걷기,
  2026-07-23 `courses.json`).
