...
| FR-21 | 마커가 서로 겹칠 만큼 가까우면 하나로 묶어 개수를 보여준다. 묶는 기준은 팝업과 축제가 500m, 코스가 1km다 (2026-08-15 확정, §8 참조). 묶인 것을 선택하면 목록이 그 미션들로 좁혀진다 | Must |
...
- **마커를 묶는 일은 화면이 한다. 기준은 팝업과 축제 500m, 코스 1km다.** 서버는 뷰포트 안
