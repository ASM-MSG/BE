...
| FR-5 | 세는 대상은 살아 있는 내 영상뿐이다. 삭제된 영상과 신고로 가려진 영상은 빼고, 아직 인코딩 중이거나 비공개로 둔 영상은 센다. 도감 화면이 내 영상을 세는 기준(동 단위 내 영상 조회)과 글자 그대로 같아야 하며, 같은 지역을 두 화면에서 봤을 때 숫자가 달라지면 안 된다 | Must |
